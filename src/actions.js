...
export function loadRestaurantsDetail({ restaurantsId }) {
  return async (dispatch) => {
    const restaurantsDetail = await fetchRestaurantsDetail({ restaurantsId });

    dispatch(setRestaurantsDetail(restaurantsDetail));
  };
}
